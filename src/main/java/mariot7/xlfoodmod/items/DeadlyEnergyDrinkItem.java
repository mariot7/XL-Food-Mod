...
public class DeadlyEnergyDrinkItem extends ItemFoodXL {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving)
	{
        if(entityLiving instanceof PlayerEntity)
        {
        	...
        	entityLiving.addPotionEffect(new EffectInstance(Effects.POISON, 1200, 0, false, false));
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
	{
		...
		tooltip.add(new TranslationTextComponent(this.getTranslationKey() + ".tooltip").applyTextStyle(TextFormatting.RED));
	}
