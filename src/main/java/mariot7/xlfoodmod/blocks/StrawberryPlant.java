...
public class StrawberryPlant extends CropsBlock {
    ...
    protected boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos)
    {
 	...
 	protected IItemProvider getSeedsItem()
  	{
 		return ItemListXL.STRAWBERRY_SEEDS;
  	}
    ...
    public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult hit)
    {
    	if(!world.isRemote)
		{
			...
			{
				world.addEntity(new ItemEntity(world, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ItemListXL.STRAWBERRY, world.rand.nextInt(3) + 1)));
