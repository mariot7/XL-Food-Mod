...
public class Craftingxlfoodmod {
	...
	public static void initRecipes() {
		...
		GameRegistry.addRecipe(new ItemStack(ItemListxlfoodmod.pumpkin_stew), new Object [] {" E ","OGC"," P ", 'E', ItemListxlfoodmod.pepper, 'O', Items.POTATO, 'G', ItemListxlfoodmod.ground_beef, 'C', Items.CARROT, 'P', Blocks.PUMPKIN});
